...
def main_generate_2D():
    """Used to generate the 2D dataset for the Black Sea"""
    ...
    for m in months:
        for y in years:
            ...
            # Displaying information over the terminal (1)
            print(f"Temperature - {m}/{y}:\nMin = {t_min}\nMax = {t_max}")
            print(f"Salinity - {m}/{y}:\nMin = {s_min}\nMax = {s_max}")
            print(f"Chlorophyll - {m}/{y}:\nMin = {c_min}\nMax = {c_max}")
            print(f"Kshort - {m}/{y}:\nMin = {kshort_min}\nMax = {kshort_max}")
            print(f"Klong - {m}/{y}:\nMin = {klong_min}\nMax = {klong_max}")
            print(f"Oxygen - {m}/{y}:\nMin = {o_min}\nMax = {o_max}")
